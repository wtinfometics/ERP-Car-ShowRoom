...
const SalesREFDashboard = () => {
    ...
    const DisplayCustomerPerMonth = (e) => {
        axios.get(`${API_URL}getcustomerofemployeeinthismonth`, { headers: AuthHeader() }).then((response) => {
    ...
    const DisplaySales = (e) => {
        axios.get(`${API_URL}GetOrdersOfEmployeeinthismonth`, { headers: AuthHeader() }).then((response) => {
...
export default SalesREFDashboard